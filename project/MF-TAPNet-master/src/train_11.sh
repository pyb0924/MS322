...
CUDA_VISIBLE_DEVICES=4,5,6,7 python3.6 train.py --device_ids 0 1 2 3 --num_workers 8 --batch_size 16 --folds 0 1 2 3 --problem_type parts --lr 3e-5 --model UNet11 --jaccard_weight 0.3 --max_epochs 100 --model_save_dir ../model_ckpt --input_height 512 --input_width 640
